      ...
      {/*  <Navbar/> */}
       ...
       <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 min-h-screen">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            Navigate the Future Seamlessly
            </h1>

            <p className="max-w-2xl mb-6 font-light text-gray-600 lg:mb-8 md:text-lg lg:text-xl mt-5 lg:mt-8 font-play">
            Embark on a journey of innovation and effortless exploration with NovaNudge. We believe in simplifying your digital experience, providing you with tools and insights that propel you into the future. Discover the ease of connectivity and the power of streamlined solutions.
            </p>
            ...
            <a
              href="#"
              className=" mt-3 inline-flex items-center justify-center px-4 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 hover:bg-slate-200 rounded-full"
            >
              Learn More
            </a>
